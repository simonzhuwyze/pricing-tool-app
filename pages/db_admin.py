...
# --- CSV -> Azure SQL Sync ---
styled_divider(label="3. Sync CSV to Cache", icon="arrow-left-right")
st.markdown(
...
# --- Override Management ---
styled_divider(label="6. User Overrides", icon="sliders")

from core.ui_helpers import styled_tabs
override_tab = styled_tabs(
    ["View Overrides", "Add Override", "Audit Log"],
    icons=["eye", "plus-circle", "journal-text"],
    key="db_override_tabs",
)

if override_tab == "View Overrides":
...
elif override_tab == "Add Override":
